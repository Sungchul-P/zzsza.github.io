...
- **MySQL 서버 설치**
  - 필수 조건은 아니지만, 서버가 필요한 서비스를 위해 미를 설치를 진행합니다.  
...
- 설치를 진행할 때 많은 포트를 사용하므로, 방화벽을 내려야 원활하게 진행된다.

> sudo systemctl disable firewalld  
> sudo service firewalld stop  


- 정상적으로 ambari-server가 설치됐다면, 8080 포트로 브라우저에서 접속할 수 있다.
  - 마스터 노드가 192.168.103.104 이므로 192.168.103.104:8080 으로 접속하면 된다.
